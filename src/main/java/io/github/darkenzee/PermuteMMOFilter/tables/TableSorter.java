 ...
 * a mouse listener is installed with the following behaviour:
 * <ul>
 * <li>
...
public class TableSorter extends AbstractTableModel {
    private static final long serialVersionUID = -644233384548231206L;
 ...
 */
    public int indexOfViewToModel(int viewIndex) {
        ...
        try{
            ...
            //sometimes method throws a null pointer - will this help?
            return 0;
        }
    }
    ...
    private int[] getModelToView() {
        if (modelToView == null) {
            ...
            for (int i = 0; i < n; i++) {
                modelToView[indexOfViewToModel(i)] = i;
            }
        }
        return modelToView;
    }
    ...
    public boolean isCellEditable(int row, int column) {
        return tableModel.isCellEditable(indexOfViewToModel(row), column);
    }
 
    public Object getValueAt(int row, int column) {
        return tableModel.getValueAt(indexOfViewToModel(row), column);
    }
 
    public void setValueAt(Object aValue, int row, int column) {
        tableModel.setValueAt(aValue, indexOfViewToModel(row), column);
    }
        ...
        public Component getTableCellRendererComponent(JTable table, 
            ...
            if (c instanceof JLabel) {
                ...
                try {
                  ...
                  //WVD has added this try catch May 2006.  He is not too impressed with this class.
                }
